...
service GestionaAsientos {
    entity CabeceraAsiento            as
        projection on my.CabeceraAsiento {
            *,
            estadoSolicitud,
            sectorSolicitante,
            tipoAsiento,
...
annotate CatalogService.ConfigAdjuntosObligatorios with @UI.CreateEnabled: false;
annotate CatalogService.ConfigAdjuntosObligatorios @UI.CreateHidden: true;
annotate CatalogService.ConfigAdjuntosObligatorios with @odata.draft.enabled;
